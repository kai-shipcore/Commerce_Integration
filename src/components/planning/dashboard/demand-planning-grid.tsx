...
const SORT_VALUE_BY_COLUMN: Partial<Record<string, (row: DemandRow) => SortValue>> = {
  ...
  f90: (row) => row.fba_90d_sales,
  f60: (row) => row.fba_60d_sales,
  f30: (row) => row.fba_30d_sales,
  f15: (row) => row.fba_15d_sales,
  f7: (row) => row.fba_7d_sales,
  fpre: (row) => row.fba_30d_pre,
  ...
  oos_days: (row) => row.oos_days_90d,
  oos_lost: (row) => row.oos_lost_demand_90d,
  ...
  return (
    <>
      <style>{`
        ...
        .sc-part { background: #FCE7F3; color: #BE185D; }
